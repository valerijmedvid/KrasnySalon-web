<template>
  <article>
		<h1>Objemové prodlužování řas</h1>
		<div class="services">
			<p>
			...
			<p>Prodloužené řasy se musejí průběžně doplňovat, z důvodu obnovy vlastních řas. Délka cyklu růstu řasy je průměrně 90 dní.
				Když přírodní řasa vypadne, vyroste na jejím místě řasa nová, která se při dalším doplnění opět prodlouží. Z tohoto důvodu
				je ideální řasy doplňovat každých 2-4 týdnů, aby byl zachován plný objem a perfektní vzhled.</p>
			<h2>Jak prodloužení řas probíhá?</h2>
			<p>Klientka leží pohodlně na lehátku. Pokud nosíte kontaktní čočky, před prodloužením je vyjměte. Spodní víčko a řasy jsou
			...
			<p>Prvních 24 hodin po aplikaci se vyhněte kontaktu s vodou, 48 hodin nenavštěvujte saunu. Řasové spoje by se po tak krátké
				...
				řasy nepoužívejte řasenku! Ta se u kořínků spojuje s lepidlem a při doplnění je třeba tento nános odstranit. Řasenku
				je možné používat pouze na spodní řasy. V případě nutnosti je možno použít řasenku určenou přímo na prodloužené řasy.
				Nepoužívejte kleštičky na řasy, oči nemněte a vyhněte se olejovým přípravkům v okolí očí.</p>
			<p>
