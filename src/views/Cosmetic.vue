	...
	<article>
		...
		<div class="services">
			...
			<p>SynCare je spojení latinské předpony SYN - pro a anglického slova CARE – péče. Vyjadřuje přesvědčení, že kosmetika SynCare
				...
				stav a svou vnitřní rovnováhu. Abychom docílili zdravého, jasného a mladistvého vzhledu, je nutné dodávat pleti a pokožce
				potřebné látky pro jejich výživu.</p>

			<h2>Certifikovaná biokosmetika</h2>
			<p>SynCare je bez syntetických konzervačních látek, barviv, živočišných surovin, minerálních olejů, etoxylovaných emulgátorů
			...
			<p>Značka SynCare přináší na trh profesionální dermo a bio přípravky na hranici lékařské a estetické péče. Je určena pro
				...
				defekty (ekzémy, periorální dermatitida, rosacea, poškození slunečním zářením.)</p>

			<p>Ke všem klientkám přistupujeme individuálně, protože každá pleť je jiná. Typ ošetření určujeme až po diagnóze pleti, kterou
				zdarma provádíme v salonu.</p>

			<p>
				<strong>Ke kosmetickému ošetření máte u nás možnost dopřát si parafínový zábal na ruce za zvýhodněnou cenu 50,-</strong>
			</p>
